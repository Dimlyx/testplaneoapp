...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const { data: clients, error: clientsError } = await supabaseAdmin
      .from('clients')
      .insert([
        { name: 'Martin Pierre', client_type: 'individual', address: '5 Avenue Victor Hugo', city: 'Lyon', postal_code: '69001', email: 'p.martin@email.fr', phone: '06 12 34 56 78', organization_id: orgId, has_maintenance_contract: false },
        { name: 'SCI Les Fontaines', client_type: 'professional', address: '28 Rue du Commerce', city: 'Marseille', postal_code: '13001', email: 'contact@lesfontaines.fr', phone: '04 91 23 45 67', organization_id: orgId, has_maintenance_contract: true, contract_start_date: sixMonthsAgo, contract_end_date: inSixMonths, contract_type: 'Contrat Premium climatisation', contract_visits_per_year: 4, contract_notes: 'Entretien semi-annuel des splits. Garantie pièces et main-d’œuvre incluse.' },
        { name: 'Durand Famille', client_type: 'individual', address: '14 Chemin des Lilas', city: 'Bordeaux', postal_code: '33000', email: 'famille.durand@email.fr', phone: '05 56 78 90 12', organization_id: orgId, has_maintenance_contract: false },
        { name: 'Restaurant Le Gourmet', client_type: 'professional', address: '8 Place Bellecour', city: 'Lyon', postal_code: '69002', email: 'contact@legourmet.fr', phone: '04 72 11 22 33', organization_id: orgId, has_maintenance_contract: true, contract_start_date: todayStr, contract_end_date: inOneYear, contract_type: 'Contrat Standard CVC', contract_visits_per_year: 2, contract_notes: 'Visites préconisées en début de saison chauffage et climatisation.' },
